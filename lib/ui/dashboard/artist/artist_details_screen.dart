                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            mdlArtistData.image?.isNotEmpty ?? false
                                ? Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: mdlArtistData.image?.last.url !=
                                              "https://static.saavncdn.com/_i/share-image-2.png"
                        ...
                        (mdlArtistData.topSongs?.isNotEmpty ?? false) ||
                                (mdlArtistData.singles?.isNotEmpty ?? false)
                            ? Container(
                                child: Column(
                                  children: [
                                    mdlArtistData.topSongs?.isNotEmpty ?? false
                                    ...
                                    SongList(
                                      ...
                                      onTap: (value) {
                                        if (mdlArtistData.singles?[value]
                                                .downloadUrl?.isNotEmpty ??
                                            false) {
                                          LoginUser.instance.playingSong.value =
                                              MDlPlayingSongs(
                                                  songs:
                                                      mdlArtistData.singles ??
                                                          [],
                                                  currentPlayingIndex: value);
                                          LoginUser
                                    ...
                                    AlbumList(
                                        albumList:
                                            mdlArtistData.topAlbums ?? []),
                                    ArtistList(
                                        artistList:
                                            mdlArtistData.similarArtists ?? []),
                                    SizedBox(
                                      height: 70.h,
                                    ),
                                  ],
            ...
            onTap: () async {
              ...
              if (isAlreadyInList) {
                LoginUser.instance.preferSinger
                    .removeWhere((singer) => singer.name == mdlArtistData.name);
              } else {
                LoginUser.instance.preferSinger.add(
                  Singers(
                      name: mdlArtistData.name ?? '',
                      image: mdlArtistData.image?.last.url ?? '',
                      url: true),
                );
              }
            ...
            onTap: () {
              setState(() {
                if (LoginUser.instance.player.playing &&
                    LoginUser.instance.currentPlayAlbumId == mdlArtistData.id) {
